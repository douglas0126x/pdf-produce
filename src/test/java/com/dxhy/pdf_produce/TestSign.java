...
public class TestSign implements Runnable {
	...
	String dxhy = "D:\\work\\eclipse_workspace\\eclipse2_workspace\\pdf-produce\\tmp\\dxhy\\dxhy2.pdf";
	// 签章后文件的路径
	String resultPath = "tmp\\";
	...
	private void ShanDongSign() {
		...
		*/
		signByPosition(dxhy, resultPath+"signByPosition_00.pdf", orgcpde, sealcpde, 504, 60, 1, TSA_type,"", 0.7f);
		/*
